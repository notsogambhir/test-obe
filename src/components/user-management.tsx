...
export function UserManagement() {
  ...
  const handleCreateUser = async () => {
    ...
    if (!formData.email && !formData.employeeId) {
      toast.error('At least one of Email or Employee ID is required for account identification');
      return;
    }
  ...
  const handleResetPassword = async () => {
    if (!resettingUser || !resetingPassword) {
      toast.error('New password is required');
      return;
    }

    if (resetingPassword.length < 8) {
      toast.error('Password must be at least 8 characters long');
      return;
    }
    ...
    try {
      const response = await fetch(`/api/users/${resettingUser.id}`, {
        ...
        body: JSON.stringify({ password: resetingPassword }),
      });
        ...
        <Dialog open={isCreateDialogOpen} onOpenChange={setIsCreateDialogOpen}>
          ...
          <DialogContent className="sm:max-w-[600px]">
            ...
            <div className="grid gap-4 py-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <Input
                    ...
                    placeholder="Optional if Employee ID provided"
                  />
                </div>
                <div>
              ...
              {['DEPARTMENT', 'PROGRAM_COORDINATOR', 'TEACHER'].includes(formData.role) && (
                <div>
                  <Label htmlFor="college">College *</Label>
                  <Select
              ...
              {['PROGRAM_COORDINATOR', 'TEACHER'].includes(formData.role) && (
                <div>
                    ...
                    {user.isActive ? (
                      <AlertDialog>
                        <AlertDialogTrigger asChild>
                          <Button variant="ghost" size="sm" className="text-orange-600" title="Deactivate">
                        ...
                        <AlertDialogContent>
                          ...
                          <AlertDialogFooter>
                            ...
                            <AlertDialogAction onClick={() => handleToggleUserStatus(user)} className="bg-orange-600 hover:bg-orange-700">
                              Deactivate
                            </AlertDialogAction>
                          </AlertDialogFooter>
                        </AlertDialogContent>
                      ...
                      <AlertDialogContent>
                        <AlertDialogHeader>
                          ...
                          <AlertDialogDescription>
                            ...
                            user account. If the user has academic records, deletion will be blocked by the server.
                          </AlertDialogDescription>
                        </AlertDialogHeader>
                        <AlertDialogFooter>
                          <AlertDialogCancel>Cancel</AlertDialogCancel>
      ...
      <Dialog open={isResetDialogOpen} onOpenChange={setIsResetDialogOpen}>
        <DialogContent className="sm:max-w-[400px]">
          <DialogHeader>
            ...
            <DialogDescription>
              Enter a new password for {resettingUser?.name}
            </DialogDescription>
          </DialogHeader>
          <div className="grid gap-4 py-4">
            <div className="space-y-2">
              ...
              <Input
                id="new-password"
                type="password"
                value={resetingPassword}
                onChange={(e) => setResetingPassword(e.target.value)}
                placeholder="Min 8 characters"
              />
            </div>
          </div>
